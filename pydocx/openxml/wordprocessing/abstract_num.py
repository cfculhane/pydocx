...
class AbstractNum(XmlModel):
    ...
    def get_indentation_between_levels(self):
        ...
        try:
            lvl0_ind = self.levels[0].paragraph_properties.to_int("indentation_left", default=0)
            lvl1_ind = self.levels[1].paragraph_properties.to_int("indentation_left", default=0)
