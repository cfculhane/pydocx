...
class DetectParentChildMapTestCase(NumberingSpanTestBase):
    ...
    def create_container(self):
        ...
        container = type(
            str("Container"),
            (object,),
            {"numbering_definitions_part": type(str("Numbering"), (Numbering,), {"numbering": numbering})},
        )
    ...
    def create_numbering_paragraph(self, num_id, level_id="0", container=True):
        paragraph_params = {
            "properties": ParagraphProperties(
                numbering_properties=NumberingProperties(num_id=num_id, level_id=level_id)
            )
        }
    ...
    def test_invalid_input_components(self):
        components = [
            ...
            Paragraph(properties=ParagraphProperties(numbering_properties=NumberingProperties())),
